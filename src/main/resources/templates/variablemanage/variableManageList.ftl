...
<!--页面处理结果-->
<div id="active_result_variable" class="alert alert-danger" style="display:none"></div>

<div class="am-form-inline" id="search-box">
    <form id="r_searchForm" method="post">
        <span>位置：</span>
        <div class="am-form-group">
            <select class="search-input data-am-selected" name="location" id="variableLocation">
            </select>
        </div>

        <button type="button" class="am-btn am-btn-primary" id="searchVariable">搜索</button>
        <button type="button" class="am-btn am-btn-primary" id="clear-btn_variable">清空</button>
        <button type="button" class="am-btn am-btn-primary" id="insertVariable">新增</button>
...
<!-- 新增/编辑 设置的div -->
<div class="modal fade" id="variableManageEditModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
...
<script type="text/javascript" src="${base}/static/js/variablemanage/variableManageList.js"></script>
</body>
</html>