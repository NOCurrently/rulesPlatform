...
<table class="am-table am-table-bordered am-table-hover am-table-striped am-table-compact">
    ...
    <tr>
        ...
        <th nowrap="nowrap" style="width: 10%;">类别</th>
        <th nowrap="nowrap" style="width: 16%;">位置</th>
        <th nowrap="nowrap" style="width: 10%;">活动状态</th>
        <th nowrap="nowrap" style="width: 25%;">内容</th>
