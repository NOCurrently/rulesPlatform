...
<div class="content_wrap">
    <div id="richTextTree" style="width: 19%;float:left;"></div>
    <div id="richTextRightDivdatas" style="width: 80%;float:left;"></div>
</div>
...
<script type="text/javascript" src="${base}/static/js/richtext/richTextTree.js"></script>
</body>
</html>