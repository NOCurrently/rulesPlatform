...
<div class="modal fade" id="createDictTypeModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="r_dictTypeForm" class="form-horizontal" role="form" method="post" action="${base}/web/dict/addSysDictType">
                <div class="modal-body">
...
<script type="text/javascript" src="${base}/static/js/dict-list.js"></script>
