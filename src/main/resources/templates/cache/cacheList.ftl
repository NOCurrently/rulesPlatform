...
<div class="am-form-inline" id="search-box">
    ...
    <button class="am-btn  am-btn-primary btn-danger" id="cleancache-button">选择清除缓存</button>
</div>
<div>
...
<!-- 查看信息 -->  
<div class="modal fade" id="observedModel">  
  <div class="modal-dialog">  
    <div class="modal-content message_align">  
      <div class="modal-header">  
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>  
      ...
      <div class="modal-body" id="cacheValue" style="overflow:scroll;">  
      </div>  
...
<script type="text/javascript" src="${base}/static/js/cache/cache.js"></script>
