<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div id="pop-ad_result" class="alert alert-danger" style="display:none"></div>


        <form id="pop-ad_EditForm" class="form-horizontal" method="post" action="${base}/backendContent/savaPopAd">
            <input type="hidden" name="menuId" value="${menuId!}">
            <input type="hidden" name="infoId" <#if info??>value="${info.id!}"</#if> >
            <input type="hidden" id="baseUrlId" value="${base}">
            <div class="modal-body">
                <div class="form-group">
                    <label for="pop-ad_title" class="col-sm-3 control-label"><strong class="text-danger">*</strong>名称</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="title" id="pop-ad_title" placeholder="名称"
                               <#if info??>value='${info.title!}'</#if>>
                    </div>
                </div>

                <div class="form-group">
                    <label for="pop-ad_subTitle" class="col-sm-3 control-label">副标题</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="subTitle" id="pop-ad_subTitle" placeholder="副标题"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="hidden" id="targetBannerUserDefVal" <#if info??>value="${info.targetUser!}"</#if>>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div id="targetCrowdId">
                            ...
                            <select  style="width: 200px;float: left;" class="search-input am-form-field" id="targetCrowdId" name="targetCrowdId" onchange="getCrowdDetail('${base}',this.value,'pop-ad_result')">
                            ...
                            <input type="text" style="width: 200px;float: right;" class="form-control" id="inputTargetCrowdId" onblur="initTargetCrowd(this.value, 'pop-ad_result');" placeholder="请输入目标人群id">
                        </div>
                    </div>
                </div>
                <div id="crowList">
                ...
                <div class="form-group">
                    <label for="pop-ad_dataCoding" class="col-sm-3 control-label"><strong class="text-danger"></strong>数据编码</label>
                    <div class="col-sm-9">
                        <select id="pop-ad_dataCoding" class="form-control" name="pop-ad_dataCoding" >
                        </select>
                ...
                <div class="form-group">
                    <label for="pop-ad_jumpType" class="col-sm-3 control-label"><strong class="text-danger">*</strong>跳转类型</label>
                    <div class="col-sm-9">
                        <select id="pop-ad_jumpType" class="form-control" name="type" >
                        </select>
                ...
                <div class="form-group">
                    <label for="pop-ad_jumpUrl" class="col-sm-3 control-label"><strong
                            class="text-danger">*</strong>跳转页面(地址)</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="jumpUrl" id="pop-ad_jumpUrl" placeholder="跳转页面(地址)"
                ...
                <div class="form-group">
                    <label for="pop-ad_remarks" class="col-sm-3 control-label">备注说明</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="remarks" id="pop-ad_remarks" placeholder="请输入你的描述"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="pop-ad_saveBtn">保存</button>
            </div>
        </form>
...
<script type="text/javascript" src="${base}/static/js/content/template/pop-ad.js"></script>
